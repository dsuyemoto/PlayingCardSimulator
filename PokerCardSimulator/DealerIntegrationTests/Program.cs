...
namespace DealerIntegrationTests
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            _holdem.SeatPlayer(new Player(0, 1000, (o) => { return new PromptActions() { PlayerAction = Player.PlayerAction.Call }; }), 1);
            _holdem.SeatPlayer(new Player(1, 2000, (o) => { return new PromptActions() { PlayerAction = Player.PlayerAction.Check }; }), 2);
            _holdem.Deal();
